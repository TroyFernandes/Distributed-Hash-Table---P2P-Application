 ...
 * 
 * NOTE: This class is needed for the P2P client since they are aware of the location of the first DHT Server Node
 */
public interface DHTRMIInterface extends Remote, Serializable {

	// Tells the SUCCESSOR DHT Node they are by indicating their serverID and
	// serverIP
